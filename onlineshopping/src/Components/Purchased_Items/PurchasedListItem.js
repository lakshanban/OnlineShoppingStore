...
export default function PurchasedListItem(props){
    ...
    useEffect(()=>{
        ...
        axios.post('http://localhost:8080/getallproductsfromorder',{"username":props.user}).then(res=>{
